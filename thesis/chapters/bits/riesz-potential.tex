$(-\Delta)^{-\gamma}$ denotes the inverse fractional Laplacian $\Delta := \nabla^2$ with power $\gamma \in (0, 1)$.
...
Many results may still be carried over however and we move on to stating and proving \Cref{thm:theorem216}.

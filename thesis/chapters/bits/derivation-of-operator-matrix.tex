Considering only a single power-law operator
$$\hat{Q}^\beta[\rho](\vec{x}) := \frac{1}{\beta} \int_{B_1(\vec{0})} \norm{\vec{x}-\vec{y}}^\beta \,\dd\vec{y}\,,$$
from the ansatz $\rho(\vec{x})$ (cf. \Cref{eq:ansatz}) we have
\begin{equation}

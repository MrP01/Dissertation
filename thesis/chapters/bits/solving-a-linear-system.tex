...
Solving it instead of the original system given in \Cref{eq:the-linear-system} results in a slight error in the solution, depending on the value of $s$ (TODO: add analytic-solution figure here), but the Tikhonov regularisation greatly improves the coefficient decay when adding more terms to the expansion. % TODO: resolve todo.

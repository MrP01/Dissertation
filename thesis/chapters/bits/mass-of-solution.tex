...
\begin{proof}[Proof (from \cite{2021-arbitrary-dimensions})]
  ...
  \end{align*}
  which relies on the classical orthogonality condition of the Jacobi polynomials given in \Cref{eq:jacobi-orthogonality-condition} with the $0$th polynomial $P_0(u) = 1$.
\end{proof}

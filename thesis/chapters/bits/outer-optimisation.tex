...
While the exact value of $R_{\rm opt}$ in \Cref{lemma:attrep-energy-min} is not particularly useful in most scenarios as it only holds for $N = 1$, it provides a solid initial guess for the optimisation routine.

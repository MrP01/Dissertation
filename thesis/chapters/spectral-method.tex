...
\begin{figure}[H]
  ...
  \includegraphics[width=0.5\linewidth]{results/default/full-operator.pdf}
  \caption{Operator}
\end{figure}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.8\linewidth]{results/default/solution-increasing-order.pdf}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.8\linewidth]{results/outer-optimisation.pdf}

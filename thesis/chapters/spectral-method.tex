...
\begin{figure}[H]
  ...
  \includegraphics[width=0.6\linewidth]{results/known-analytic/convergence-to-analytic.pdf}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.7\linewidth]{results/attrep/convergence.pdf}
...
\begin{figure}[H]
  ...
  \includegraphics[width=0.6\linewidth]{results/attrep/energy-dependence-on-r.pdf}

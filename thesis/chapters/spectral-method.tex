...
\begin{figure}[H]
  ...
  \caption[Solutions of increasing orders]{Particle density distribution function solutions $\rho$ of increasing order $N$ to the attractive-repulsive problem with interaction potential $K_{alpha, \beta}(r)$, $\alpha = 2.5$ and $\beta = 1.2$. Reflected along the y-axis for better illustration of the domain.}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Outer Optimisation Routine]{Total potential $U$ as a function of the interval radius $R$.}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Comparison with analytical solutions and error]{The analytic solution $\rho(x)$ given in \Cref{eq:analytical-solution-alpha-equal-2} compared to the (spectral method) solutions of different order $N$.}
\end{figure}

\begin{figure}[H]
  \centering
  \label{fig:convergence-to-analytic}
  \includegraphics[width=0.7\linewidth]{results/convergence-to-analytic.pdf}

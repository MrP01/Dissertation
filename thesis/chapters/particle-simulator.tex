...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.63\linewidth]{results/gyroscope-3d/simulation-quiver-3d.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.63\linewidth]{results/gyroscope-3d/simulation-fcc-3d.pdf}

...
The spectral method introduced in \Cref{chap:spectral-method} is only capable of handling the attractive-repulsive case due to the specific form of the integral appearing in its construction (cf. \Cref{thm:theorem216}).
% Solving with another kernel would involve the explicit evaluation of another such integral, if possible at all and even then it is non-trivial to do.

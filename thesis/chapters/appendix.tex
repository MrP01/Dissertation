...
We were able to reproduce this for an attractive-repulsive interaction kernel, cf. \Cref{fig:void-2d-quiver}.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{results/mixed-2d/simulation-quiver.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\linewidth]{results/void-2d/simulation-quiver.pdf}

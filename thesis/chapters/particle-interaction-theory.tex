...
\begin{figure}[H]
  ...
  \caption{Position and velocity of particles in the simulation. Reproduced plot from \cite{2006-self-propelled}.}
  % \paragraph{Link to Particle Simulator, give a Screenshot}
\end{figure}

\hierKoennteIhreWerbungStehen

% TODO: Friction Term -\textgreater{} Energy Dissipation -\textgreater{} Different Plot

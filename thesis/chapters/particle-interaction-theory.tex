...
In our case however, we will only refer to attractive-repulsive \textit{powerlaw} (sometimes also called Riesz) potentials, specifically of the form in \Cref{eq:attractive-repulsive-potential}.

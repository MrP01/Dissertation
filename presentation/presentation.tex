...
\begin{document}
  ...
  \begin{frame}{Upcoming Work}
    ...
    \begin{itemize}
      ...
      \item Compare results of the two methods and analytical solutions of special cases \cite{2014-explicit-flock-solutions-for-quasi-morse-potentials}.
    \end{itemize}
    ...
    \begin{itemize}
      ...
      \item Optionally: Extending to l-Morse potentials $K(r) = C_1 \e^{r / l_1} - C \e^{r / l}$.
    \end{itemize}
  \end{frame}
